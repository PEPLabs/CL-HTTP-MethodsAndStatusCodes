...
public class Main {
     ...
     * 
     * This method initializes a new Javalin object, sets up endpoints, and associates them with their related handler methods.
     *
    ...
    public static Javalin getJavalinInstance() {
        ...
        // Below is an example endpoint. Its associated handler is the handleGetRequest method
        app.get("/get-request", Main::handleGetRequest);

        // TODO: create the POST endpoint to the "/post-request" path and associate it with the handler method you will create named handlePostRequest
        
        // TODO: create the PUT endpoint to the "/put-request" path and associate it with the handler method you will create named handlePutRequest
        
        // TODO: create the DELETE endpoint to the "/delete-request" path and associate it with the handler method you will create named handleDeleteRequest
        
        // TODO: create the PATCH endpoint to the "/patch-request" path and associate it with the handler method you will create named handlePatchRequest
     ...
     *
     * @param ctx - The Javalin Context object containing information about the HTTP request and response.
     */
    ...
    /**
     * The handlePostRequest method handles POST requests to the "/post-request" path.
     * 
    ...
    /**
     * The handleDeleteRequest method handles DELETE requests to the "/delete-request" path.
     * 
    ...
    /**
     * The handlePatchRequest method handles PATCH requests to the "/patch-request" path.
     * 
